...
function create(node, id, self) {
  ...
  function start(elapsed) {
    ...
    for (i in schedules) {
      ...
      // chance to tick (and possibly end); see d3v4/d3v4-transition#54!
    ...
    // Defer the first tick to end of the current frame; see d3v4/d3v4#1576.
    // Note the transition may be canceled after start and before the first tick!
    // Note this must be scheduled before the start event; see d3v4/d3v4-transition#16!
...
// Like d3v4.local, but with the name “__brush” rather than auto-generated.
function local(node) {
...
// TODO Use d3v4-polygon’s polygonContains here for the ring check?
